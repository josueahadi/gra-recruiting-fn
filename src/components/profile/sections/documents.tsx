...
const DocumentsSection: React.FC<DocumentsSectionProps> = ({
  ...
  const [updatedLinks, setUpdatedLinks] = useState<PortfolioLinks>(portfolioLinks);
  ...
  return (
    <>
      ...
      <ProfileSection
        title="Resume"
        canEdit={false} // No edit button for this section
        isEditing={false}
        onEdit={() => {}}
        onSave={() => {}}
      >
               ...
               {samples.map((sample, index) => (
                 ...
                 >
                   ...
                   {canEdit && (
                     <Button
                       variant="ghost"
                       onClick={() => onFileRemove('sample', index)}
                       className="text-red-500 hover:text-red-700 p-1 h-auto"
                     >
                       <X className="h-4 w-4" />
                     </Button>
