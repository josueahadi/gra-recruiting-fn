...
const DocumentsSection = () => {
	...
	const handleUploadCV = () => {
		// Implementation for handling CV upload would go here
	...
	return (
		<SectionLayout title="Documents & Portfolio">
			{/* Resume/CV Section */}
			<SectionItem title="Resume/CV" showEditButton={false}>
					...
					<div className="flex items-center  mt-4">
						...
						>
							<div className="flex items-center">
								<HiOutlineCloudUpload className="  text-primary-base mr-2" />
								Resume/CV Upload
							</div>
						</Button>
						<input
